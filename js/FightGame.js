class FightGame {
    ...
    introGame(isVsMode, nameOne, nameTwo) {
        this.isVsMode = isVsMode;
        this.nameFirstFighter = nameOne;
        this.nameSecondFighter = nameTwo;
    }
    ...
    canvasGame(oneCompWidth, oneCompHeight, secondCompWidth, secondCompHeight, imgSrcLeft, imgSrcRight, velocityComp, countCompCrash, elemTitleRound, isFirstPlayerWinner) {
